...
<section class="wrap user_form">
 ...
 <div class="rt_form">
  ...
  <ul>
   <li class="user_icon">
    <input type="text" name="userName" class="textbox" placeholder="账号"/>
   </li>
   <li class="user_pwd">
    <input type="password" name="userPassword" class="textbox" placeholder="密码"/>
   </li>
   <li class="link_li">
    <a href="register.html" title="注册新用户" class="fl">注册新用户</a>
    <a href="find_pwd" title="忘记密码" class="fr">忘记密码？</a>
   </li>
   <li class="link_li">
