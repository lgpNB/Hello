...
<section class="wrap user_form">
 ...
 <div class="rt_form">
  ...
  <ul>
   <li class="user_icon">
    <input type="text" name="userTel" class="textbox" placeholder="手机号码"/>
   </li>
   <li class="link_li">
   ...
   <li class="user_pwd">
    <input type="password" name="userPassword" class="textbox" placeholder="设置密码"/>
   </li>
   <li class="user_pwd">
    <input type="password" name="userPassword2" class="textbox" placeholder="确认密码"/>
   </li>
   <li class="link_li">
