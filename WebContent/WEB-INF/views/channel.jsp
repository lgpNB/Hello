  ...
  <div class="cnlCtgrRt">
     ...
     <div id="slide">
       <div class="swiper-wrapper">
         ...
         <div class="swiper-slide">
          <a href="#">
           <img src="upload/slide003.jpg"/>
          </a>
         </div>
         <div class="swiper-slide">
          <a href="#">
           <img src="upload/slide004.jpg"/>
          </a>
         </div>
       </div>
     ...
     <!--right:ad-->
     <div class="rtAd">
      <div class="adArea"><a href="product_list.html"><img src="upload/ad001.jpg"/></a></div>
      <div class="adArea"><a href="product_list.html"><img src="upload/ad002.jpg"/></a></div>
     </div>
  </div>
</div>
<!--list-->
<section class="wrap" style="overflow:hidden;">
 <div class="ltWrap">
  <h2>
   <strong>女装分类</strong>
   <a href="product_list.html">more</a>
  </h2>
  <aside>
  <!--classLi-->
   <ul class="classLi">
    <li><a href="product_list.html">XX女装</a></li>
    <li><a href="product_list.html">XX女装</a></li>
    <li><a href="product_list.html">XX女装</a></li>
    <li><a href="product_list.html">XX女装</a></li>
    <li><a href="product_list.html">XX女装</a></li>
   ...
   <!--ad:pic-->
   <div class="adPic">
    <a href="product_list.html"><img src="upload/ad005.jpg"/></a>
   </div>
  </aside>
  <!--product list-->
  <ul class="goodsLi">
 ...
 <div class="ltWrap">
  ...
  <!--classLi-->
   ...
   <!--ad:pic-->
   <div class="adPic">
    <a href="product_list.html"><img src="upload/ad006.jpg"/></a>
   </div>
  </aside>
  <!--product list-->
  <ul class="goodsLi">
